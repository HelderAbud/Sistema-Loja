...
class LojappLayerArchitectureTest {
    ...
    static final ArchRule controllers_use_service_and_application_contracts_only =
            noClasses()
                    ...
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.service.CommissionCatalogService")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.service.CommissionReportService")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.application.usecases.sale.CreatePosSaleUseCase")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.application.usecases.cash.OpenCashSessionUseCase")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.application.usecases.cash.CloseCashSessionUseCase")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.application.usecases.cash.GetCurrentCashSessionUseCase")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.application.usecases.cash.GetCashSessionClosePreviewUseCase")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName("com.lojapp.application.usecases.nfe.ImportNfeUseCase")
                    .orShould()
                    .dependOnClassesThat()
                    .haveFullyQualifiedName(
                            "com.lojapp.application.usecases.nfe.ApplyNfeImportSuggestionsUseCase")
                    .because(
