...
**Função:** guia operacional para trabalhar neste repositório com o **Cursor** e o plugin **Superpowers**, em linha com `AGENTS.md`, **fatias verticais** e **contrato antes de improvisar** (alinhado ao resumo do método Helder que usas no teu fluxo pessoal).
...
## 4. Ligação ao método Helder (resumo)
...
Plano piloto **Normal** já no repo: `.cursor/plans/plan-2026-05-04-helder-piloto-trilha-normal.md`.
